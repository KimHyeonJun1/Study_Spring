...
//			})
	...
	viewer: function(files){
		...
		for(var file of files){
			tag += `
				<div class="file-item d-flex my-1 gap-3">
...
function setFileInfo(tag){
	...
	if( singleFile != ""){
		...
		if( preview.hasClass("profile")){
			preview.html(`<i class="font-profile fa-solid fa-user-large"></i>` )
		}
	}
...
function fileSizeOver(file, tag){
	//1K =1024b, 1M=1024*2024b, 1G=1024*1024*1024b
	if( file.size > 1024*1024*200 ){ //10M(1024*1024*10) /200k
