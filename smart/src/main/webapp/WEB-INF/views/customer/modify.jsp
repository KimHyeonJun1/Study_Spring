...
<label class="form-check-label">
  <input class="form-check-input"<c:if test="${vo.gender == '여' }">checked</c:if> type="radio" name="gender" value="여" checked>여
  </label>
</div>
	</td>
</tr>
<tr><th>전화번호</th>
	...
	maxlength="13" placeholder="010-1234-5678" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" 
	class="form-control">
		</div>
	</div></td>
</tr>
