...
function writing( tag ) {
	...
	tag.closest(".comment").find(".writing").text( input.length ) //입력글자 수 표시
}
...
$("#comment-input").on("click", function() {
	if( ${empty auth }){
		...
		$(`<textarea class="form-control h-px100 "></textarea>`)
		.appendTo( $(this) )
		.focus()
