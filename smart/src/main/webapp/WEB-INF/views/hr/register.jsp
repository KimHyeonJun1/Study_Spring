...
<tr><th>사원명</th>
	<td>
		<div class="row">
			<div class="col-auto">
		<input type="text" required placeholder="성" class="form-control" name="last_name" >
			</div>
			
			<div class="col-auto">
		<input type="text" placeholder="명" class="form-control" name="first_name">
			</div>
		</div>
	</td>
</tr>
