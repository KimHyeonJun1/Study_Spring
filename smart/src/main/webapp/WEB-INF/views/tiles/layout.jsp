        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="${category eq 'an' ? 'active' : '' } list-group-item list-group-item-action list-group-item-light p-3 ps-4" 
                       href="<c:url value='/visual/list' />">제어관리</a>
                </div>
            </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<li class="nav-item dropdown me-5">
							  ...
							  <div id="dropdown-list" class="dropdown-menu dropdown-menu-end">
							  	<h6 class="py-2 px-3">방명록 댓글 알림</h6>
							  	<div class="bg-light">
							    	...
							    	<div class="notify-comment fw-bold">내용이 들어갈 부분</div>
                            ...
                            <li class="nav-item">
                            	...
                            	<c:choose>
                            		<c:when test="${empty auth.profile }"><i class="font-profile fa-solid fa-user"></i></c:when>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${auth.name }</a>
