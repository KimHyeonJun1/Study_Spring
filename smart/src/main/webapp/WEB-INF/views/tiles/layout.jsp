        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                <div class="sidebar-heading border-bottom bg-light">
                		<a href="<c:url value='/'/>"><img src="<c:url value='/images/logo.jpg'/>" class= "w-75"></a>
                		 </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                              ...
                              <c:choose>
                              	<c:when test="${empty loginInfo.profile }"><i class="font-profile fa-solid fa-user-large"></i></c:when>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="<c:url value='/member/user/myPage'/>">마이페이지</a>
