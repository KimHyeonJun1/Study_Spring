...
<style>
#naver {
	background: url("<c:url value='/images/naver.png'/> ") center/contain
		no-repeat #03c75a
}

#kakao {
	background: url("<c:url value='/images/kakao.png'/> ") center/contain
		no-repeat #FEE500
}
</style>
</head>
		...
		<div class="col-lg-5">
			<div class="card shadow-lg border-0 rounded-lg mt-5">
				...
				<div class="mt-3 d-flex gap-4">
					<input type="button" class="btn form-control" id="naver"> <input
						type="button" class="btn form-control" id="kakao">
				</div>
			...
			<div class="card-footer text-center py-3">
				<div class="d-flex align-items-center justify-content-between my-2">
					<a class="small" href="findPassword">비밀번호찾기</a> <a class="small"
						href="join">회원가입</a>
				</div>
			</div>
		</div>
...
<script>
	$("#naver, #kakao").on("click", function() {
		//http://localhost:80/smart/member/naverLogin
		//location = $(this).attr("id") + "Login"
		
		//http://localhost:80/smart/oauth2/authorization/naver
		//http://localhost:80/smart/oauth2/authorization/kakako
